...
products = [
    ProductModel(
        name="SB Dunk Low Premium Burgundy Crush",
        image="https://balaan.com/cdn/shop/files/48daaf6d56e64a97f628c81d7ec103c560aa71d91bef1873e57c16416c571aab.jpg?v=1716210647",
        category="Category 1",
        description="Nike SB DUNK SHOES",
        price=50,
        countInStock=10,
        rating=5
    ),
